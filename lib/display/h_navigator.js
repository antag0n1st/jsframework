(function (window, undefined) {
    ...
    HNavigator.prototype.add_callback = function () {
        ...
        timeout(function(){
            if(game.stage.renderer.textureGC){
                game.stage.renderer.textureGC.run();
            }            
        },1000);
    ...
    HNavigator.prototype.update = function () {
        ...
        if (this.transition_screen !== null && !this.transition_screen.is_paused) {
            ...
            this.transition_screen.post_update(Ticker.step * Config.slow_motion_factor);
        }
        ...
        if (this.current_screen !== null && !this.current_screen.is_paused) {
            ...
            this.current_screen.post_update(Ticker.step * Config.slow_motion_factor);
        }
        ...
        if (this.new_screen !== null) {
            if (!this.new_screen.is_paused) {
                ...
                this.new_screen.post_update(Ticker.step * Config.slow_motion_factor);
            }
        }
